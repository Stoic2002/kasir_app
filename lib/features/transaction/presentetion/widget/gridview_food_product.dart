...
class GridviewFoodProduct extends StatefulWidget {
  @override
  State<GridviewFoodProduct> createState() => _GridviewFoodProductState();
}

class _GridviewFoodProductState extends State<GridviewFoodProduct> {
  @override
  void initState() {
          ...
          return Container(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                var item = state.foodProducts[index];
