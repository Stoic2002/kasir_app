...
class GridviewSnacksProduct extends StatefulWidget {
  @override
  State<GridviewSnacksProduct> createState() => _GridviewSnacksProductState();
}

class _GridviewSnacksProductState extends State<GridviewSnacksProduct> {
  @override
  void initState() {
        ...
        if (state is GetproductLoaded) {
          return Container(
            ...
            child: GridView.builder(
              ...
              itemCount: state.snackProducts.length,
              itemBuilder: (BuildContext context, int index) {
                var item = state.snackProducts[index];
